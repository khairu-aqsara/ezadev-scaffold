...
namespace Ezadev\Admin\Scaffold\Controllers;

use Ezadev\Admin\Facades\Admin;
use Ezadev\Admin\Scaffold\Scaffold\ControllerCreator;
use Ezadev\Admin\Scaffold\Scaffold\MigrationCreator;
use Ezadev\Admin\Scaffold\Scaffold\ModelCreator;
...
class ScaffoldController extends Controller
{
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->row(view('ezadev-admin-scaffold::scaffold', compact('dbTypes', 'action')));
        });
    }
